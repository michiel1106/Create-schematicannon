...
import com.bikerboys.schematicannon.foundation.blockEntity.behaviour.ValueBox;
import com.bikerboys.schematicannon.foundation.blockEntity.behaviour.ValueBox.IconValueBox;
import com.bikerboys.schematicannon.foundation.blockEntity.behaviour.ValueBox.TextValueBox;
...
public class ScrollValueRenderer {
	...
	public static void tick() {
		...
		for (BlockEntityBehaviour blockEntityBehaviour : sbe.getAllBehaviours()) {
			...
			SchematicannonClient.VALUE_SETTINGS_HANDLER.showHoverTip(tip);
		}
	}
