...
import com.bikerboys.schematicannon.foundation.blockEntity.behaviour.ValueBoxTransform.Sided;
import com.bikerboys.schematicannon.foundation.blockEntity.behaviour.scrollValue.INamedIconOptions;
...
public class ValueBox extends ChasingAABBOutline {
	...
	public static class ItemValueBox extends ValueBox {
		...
		public void renderContents(PoseStack ms, MultiBufferSource buffer) {
			...
			drawString8x(ms, buffer, count, 0, 0, 0xEDEDED);
		}
