...
import static com.bikerboys.schematicannon.foundation.gui.AllGuiTextures.PLAYER_INVENTORY;
import static com.bikerboys.schematicannon.foundation.gui.AllGuiTextures.SCHEMATIC_TABLE_PROGRESS;
...
import com.bikerboys.schematicannon.foundation.gui.menu.AbstractSimiContainerScreen;
import com.bikerboys.schematicannon.foundation.gui.widget.IconButton;
import com.bikerboys.schematicannon.foundation.gui.widget.Label;
import com.bikerboys.schematicannon.foundation.gui.widget.ScrollInput;
...
public class SchematicTableScreen extends AbstractSimiContainerScreen<SchematicTableMenu> {
	...
	protected void init() {
		...
		SchematicannonClient.SCHEMATIC_SENDER.refresh();
		List<Component> availableSchematics = SchematicannonClient.SCHEMATIC_SENDER.getAvailableSchematics();
